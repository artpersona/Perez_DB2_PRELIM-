CREATE SCHEMA "perez_HR";
CREATE TABLE "perez_HR".regions (
	region_id INT NOT NULL,
	region_name VARCHAR(25),
	PRIMARY KEY (region_id)
	);

CREATE TABLE "perez_HR".countries (
...
CREATE TABLE "perez_HR".locations (
...
CREATE TABLE "perez_HR".departments (
...
CREATE TABLE "perez_HR".employees (
...
CREATE TABLE "perez_HR".job_history (
	employee_id INT   NOT NULL,
...
ALTER TABLE "perez_HR".job_history ADD UNIQUE (
	employee_id,
	start_date
	);


CREATE VIEW "perez_HR".emp_details_view
AS
...
INSERT INTO "perez_HR".countries
VALUES (
	'IT',
	'Italy',
	1
...
INSERT INTO "perez_HR".locations
VALUES (
	1000,
...
INSERT INTO "perez_HR".employees
VALUES (
	100,
	'Steven',
	'King',
...
INSERT INTO "perez_HR".job_history
VALUES (
	102,
	TO_DATE('13-Jan-1993', '%d-%M-%Y'),
...
ALTER TABLE "perez_HR".countries ADD FOREIGN KEY (region_id) REFERENCES "perez_HR".regions(region_id);    
ALTER TABLE "perez_HR".locations ADD FOREIGN KEY (country_id) REFERENCES "perez_HR".countries(country_id);
ALTER TABLE "perez_HR".departments ADD FOREIGN KEY (location_id) REFERENCES "perez_HR".locations(location_id);
ALTER TABLE "perez_HR".employees ADD FOREIGN KEY (job_id) REFERENCES "perez_HR".jobs(job_id);
ALTER TABLE "perez_HR".employees ADD FOREIGN KEY (department_id) REFERENCES "perez_HR".departments(department_id);
ALTER TABLE "perez_HR".employees ADD FOREIGN KEY (manager_id) REFERENCES "perez_HR".employees(employee_id);
ALTER TABLE "perez_HR".departments ADD FOREIGN KEY (manager_id) REFERENCES "perez_HR".employees (employee_id);
ALTER TABLE "perez_HR".job_history ADD FOREIGN KEY (employee_id) REFERENCES "perez_HR".employees(employee_id);
ALTER TABLE "perez_HR".job_history ADD FOREIGN KEY (job_id) REFERENCES "perez_HR".jobs(job_id);
ALTER TABLE "perez_HR".job_history ADD FOREIGN KEY (department_id) REFERENCES "perez_HR".departments(department_id);